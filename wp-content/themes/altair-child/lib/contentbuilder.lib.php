...
function ppb_tour_search_func($atts, $content) {
    ...
    $return_html.= '<div class="one_fourth">
    		<label for="keyword">'.__( 'Destinație', THEMEDOMAIN ).'</label>
    		<input id="keyword" name="keyword" type="text" placeholder="'.__( 'Oraș, regiune, cuvinte cheie', THEMEDOMAIN ).'"/>
    	</div>';

    $return_html.= '<div class="one_fourth">
    		<label for="start_date">'.__( 'Data', THEMEDOMAIN ).'</label>
    		<div class="start_date_input">
    			<input id="start_date" name="start_date" type="text" placeholder="'.__( 'Plecare', THEMEDOMAIN ).'" />
    			<input id="start_date_raw" name="start_date_raw" type="hidden"/>
    			<i class="fa fa-calendar"></i>
    		</div>
    		<div class="end_date_input">
    			<input id="end_date" name="end_date" type="text" placeholder="'.__( 'Sosire', THEMEDOMAIN ).'"/>
    ...
    $return_html.= '<div class="one_fourth">
    		<label for="budget">'.__( 'Buget maxim', THEMEDOMAIN ).'</label>
    		<input id="budget" name="budget" type="text" placeholder="'.__( '100', THEMEDOMAIN ).'"/>
    	</div>';

    $return_html.= '<div class="one_fourth last">
    		<input id="tour_search_btn" type="submit" value="'.__( 'Caută', THEMEDOMAIN ).'"/>
    	</div>';
