...
?>
    ...
    <div id="page_caption">
        <div class="page_title_wrapper">
            <h1><?php printf( __( 'Rezultatele căutării pentru &quot;%s&quot;', '' ), '' . get_search_query() . '' ); ?></h1>
        </div>
    </div>
    <br class="clear"/>
            ...
            <div class="sidebar_content full_width nopadding">
                ...
                <div class="sidebar_content">
                    ...
                    <div class="search_form_wrapper">
                        <h5><?php _e( 'Căutare nouă', THEMEDOMAIN ); ?></h5>
                        <?php _e( "Dacă nu ați găsit ce căutați, încercați o altă căutare", THEMEDOMAIN ); ?><br/><br/>

                        <form class="searchform" role="search" method="get" action="<?php echo home_url(); ?>">
                            <input style="width:88%" type="text" class="field searchform-s" name="s" value="<?php the_search_query(); ?>" title="<?php _e( 'Scrieți apoi apăsați Enter', THEMEDOMAIN ); ?>">
